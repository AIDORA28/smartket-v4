...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">{{ $producto->nombre }}</p>
        </div>
    ...
    <!-- Formulario -->
    <form action="{{ route('productos.update', $producto) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="codigo_interno" id="codigo_interno" value="{{ old('codigo_interno', $producto->codigo_interno) }}"
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    ...
                    <input type="text" name="codigo_barra" id="codigo_barra" value="{{ old('codigo_barra', $producto->codigo_barra) }}"
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    ...
                    <select name="unidad_medida" id="unidad_medida" required
                        ...
                        <option value="gr" {{ old('unidad_medida', $producto->unidad_medida) == 'gr' ? 'selected' : '' }}>Gramo (gr)</option>
                        <option value="lt" {{ old('unidad_medida', $producto->unidad_medida) == 'lt' ? 'selected' : '' }}>Litro (lt)</option>
                        <option value="ml" {{ old('unidad_medida', $producto->unidad_medida) == 'ml' ? 'selected' : '' }}>Mililitro (ml)</option>
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        {{ $producto->imagen_url ? 'Subir nueva imagen (opcional)' : 'Agregar imagen' }}. 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="precio_costo" id="precio_costo" value="{{ old('precio_costo', $producto->precio_costo) }}" 
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-2 text-gray-500">S/</span>
                        <input type="number" name="precio_venta" id="precio_venta" value="{{ old('precio_venta', $producto->precio_venta) }}" 
                               step="0.01" min="0" required
                               class="w-full pl-8 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                               placeholder="0.00">
                    </div>
                ...
                <div class="md:col-span-2">
                    <div id="margen-info" class="mt-4 p-4 bg-blue-50 rounded-lg">
            ...
            <div class="space-y-6">
                <div class="flex items-center">
                    <input type="checkbox" name="maneja_stock" id="maneja_stock" value="1" 
                           {{ old('maneja_stock', $producto->maneja_stock) ? 'checked' : '' }}
                ...
                <div id="stock-fields" class="grid grid-cols-1 md:grid-cols-3 gap-6 {{ old('maneja_stock', $producto->maneja_stock) ? '' : 'hidden' }}">
                    <div>
                    ...
                    @if($producto->maneja_stock && $producto->stocks->count() > 0)
                        ...
                        <div>
                            ...
                            <div class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50 text-gray-600">
                                {{ number_format($stock->cantidad_actual, 2) }} {{ $producto->unidad_medida }}
                            </div>
                            <p class="text-xs text-gray-500 mt-1">
                                Para ajustar el stock, usar la gestión de inventario
                            </p>
                        </div>
                    @endif
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calcularMargen() {
        ...
        if (costo > 0 && venta > 0) {
            ...
            gananciaUnidad.textContent = '0.00';
        }
    }
