...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('marcas', function (Blueprint $table) {
            $table->id();
            $table->foreignId('empresa_id')->constrained('empresas')->comment('Multi-tenant: marcas por empresa');
            $table->string('nombre', 120)->comment('Nombre de la marca');
            ...
            $table->tinyInteger('activa')->default(1)->comment('Si la marca está activa');
